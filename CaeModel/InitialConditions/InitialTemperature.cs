...
{
    [Serializable]
    public class InitialTemperature : InitialCondition, IDistribution, IPreviewable, ISerializable
    {
        // Variables                                                                                                                
        ...
        // Constructors                                                                                                             
        public InitialTemperature(string name, int nodeId, double temperature, bool constant = false)
           : this(name, "", RegionTypeEnum.NodeId, temperature, constant)
        {
            _nodeId = nodeId;
        }
        public InitialTemperature(string name, string regionName, RegionTypeEnum regionType, double temperature,
                                  bool constant = false)
