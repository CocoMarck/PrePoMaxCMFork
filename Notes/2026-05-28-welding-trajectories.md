...
### `2026-05-28`
- Mover todo al arbol principal en FE Model
- En el papa que se llama trajectories debes agregar la funcion export all y el import
...
- El nombre debe sub nodos del tree; debe ser Weld1, Weld2, y etc.
